...
namespace EventoApp
{
    ...
    sealed partial class App : Application
    {
        ...
        /// </summary>
        public static string path = Path.Combine(Windows.Storage.ApplicationData.Current.LocalFolder.Path, "EventoApp.sqlite");
        public App()
        {
            this.InitializeComponent();
            this.Suspending += OnSuspending;
            if (!CheckFileExists("EventoApp.sqlite").Result)
            {
